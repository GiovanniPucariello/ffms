...
<#if parameters.leftTitle?exists><#t/>
	<label class="label" for="leftTitle">${parameters.leftTitle}</label><br />
</#if><#t/>
...
<td valign="middle" align="center">
	<#if parameters.allowAddToLeft?default(true)><#t/>
		...
		<#if parameters.doubleHeaderKey?exists><#t/>
			...
			<#-- ********** starting the override. by pracbiz ********** -->
			<#else>
 			 class="button"<#rt/>
			<#-- ********** end the override. by pracbiz ********** -->
			</#if><#t/>
...
<#if parameters.rightTitle?exists><#t/>
	<label class="label" for="rightTitle">${parameters.rightTitle}</label><br />
</#if><#t/>
<select 
