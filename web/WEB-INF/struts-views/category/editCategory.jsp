...
<div class="buttonWrapper">
	...
	<a href="javascript:submitForm('contentForm','<c:url value="/saveEditCategory.action"/>');" class="actionButton" target="_self">
	  <span><s:text name="button.edit"/></span>
	</a>
	<a href="javascript:submitForm('backForm','<c:url value="/initEditCategory.action"/>');" class="actionButton" target="_self">
...
<s:hidden name="param.categoryOid" />
</form>
