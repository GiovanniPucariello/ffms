...
<script type="text/javascript" >
	function doCreate()
	{
		...
		var url = '<c:url value="/saveAddBankCardRecord.action"/>';
...
<div class="buttonWrapper">
	...
	<a href="javascript:submitForm('resetForm','<c:url value="/initAddBankCardRecord.action"/>');" class="actionButton" target="_self">
