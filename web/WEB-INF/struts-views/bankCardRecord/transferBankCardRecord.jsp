...
<script type="text/javascript" >
	function doTransfer()
	{
		...
		var url = '<c:url value="/saveTransferBankCardRecord.action"/>';
...
<div class="buttonWrapper">
	...
	<a href="javascript:submitForm('resetForm','<c:url value="/initTransferBankCardRecord.action"/>');" class="actionButton" target="_self">
...
<s:hidden name="bankCardRecord.bcOid" id="bcOid" />
  <div>
   ...
   <tr>
      <td class="labelCell">	
          <span class="label">
          	<span>&nbsp;</span><s:text name="label.bankCardRecord.target" /></span>
      ...
      <div class="group">
        	...
        	<tr>
          		<td class="data">
                	<s:select list="cardNos" listKey="key" listValue="value" 
              			name="target" />
          		</td>
        	</tr>
        	</tbody></table>
