...
<script type="text/javascript" >
	...
	function doCreate()
	{
		...
		var url = '<c:url value="/saveAddSalaryRecord.action"/>';
	...
	function doCheck()
	{
 	...
 	function doCheckIsSaveToBankCard()
 	{
 		...
 		if ("Y" == oldvalue)
 		{
 			document.getElementById('isSaveToBankCard').checked = true;
...
<div class="buttonWrapper">
	...
	<a href="javascript:submitForm('resetForm','<c:url value="/initAddSalaryRecord.action"/>');" class="actionButton" target="_self">
