...
<script type="text/javascript" >
	function doCreate()
	{
		...
		var url = '<c:url value="/saveAddCreditCard.action"/>';
...
<div class="buttonWrapper">
	...
	<a href="javascript:submitForm('resetForm','<c:url value="/initAddCreditCard.action"/>');" class="actionButton" target="_self">
