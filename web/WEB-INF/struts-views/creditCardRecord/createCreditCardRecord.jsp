...
<script type="text/javascript" >
	function doCreate()
	{
		...
		var url = '<c:url value="/saveAddCreditCardRecord.action"/>';
...
<div class="buttonWrapper">
	...
	<a href="javascript:submitForm('resetForm','<c:url value="/initAddCreditCardRecord.action"/>');" class="actionButton" target="_self">
