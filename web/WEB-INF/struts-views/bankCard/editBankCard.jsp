...
<script type="text/javascript" >
	function doEdit()
	{
		...
		var url = '<c:url value="/saveEditBankCard.action"/>';
...
<div class="buttonWrapper">
	...
	<a href="javascript:submitForm('resetForm','<c:url value="/initEditBankCard.action"/>');" class="actionButton" target="_self">
