...
<script type="text/javascript" >
	...
	function doEdit()
	{
		...
		var url = '<c:url value="/saveEditItem.action"/>';
...
<div class="buttonWrapper">
	...
	<a href="javascript:submitForm('resetForm','<c:url value="/initEditItem.action"/>');" class="actionButton" target="_self">
